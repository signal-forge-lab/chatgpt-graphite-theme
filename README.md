...
The `main` branch preserves **ChatGPT Soft Graphite v1.0.13** as the current
stable release.

- Stable CSS: `releases/v1.0.13/chatgpt-soft-graphite.user.css`
- Stable tag: `v1.0.13`
...
- tags: immutable published versions such as `v1.0.13`
