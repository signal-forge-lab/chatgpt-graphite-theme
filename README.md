...
The `main` branch preserves **ChatGPT Soft Graphite v1.0.19** as the current
stable release.

- Stable CSS: `releases/v1.0.19/chatgpt-soft-graphite.user.css`
...
- tags: immutable published versions such as `v1.0.19`
