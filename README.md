...
The `main` branch preserves **ChatGPT Soft Graphite v1.0.14** as the current
stable release.

- Stable CSS: `releases/v1.0.14/chatgpt-soft-graphite.user.css`
- Stable tag: `v1.0.14`
...
- tags: immutable published versions such as `v1.0.14`
